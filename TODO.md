...
- [ ] Create standard markdown header with auto-generated warning
- [ ] Format task items as `- [ ] [Title](link)` for markdown tasks
- [ ] Format code tasks with file links and line numbers
- [ ] Group tasks by category when available

### 4.2 File Assembly
- [ ] Combine markdown and code tasks
- [ ] Sort tasks deterministically
- [ ] Handle empty sections gracefully
- [ ] Write to `TODO.md` with proper encoding

## Phase 5: CLI Commands (`command/*/`)

### 5.1 Scan Command (`command/scan/`)
- [ ] Parse CLI arguments (directory paths, file types, etc.)
- [ ] Execute scanning phase
- [ ] Return structured data for further processing

### 5.2 Generate Command (`command/generate/`)
- [ ] Parse CLI arguments (output path, format options)
- [ ] Execute parsing and generation phases
- [ ] Write TODO.md file
- [ ] Provide success/failure feedback

### 5.3 Init Command (`command/init/`)
- [ ] Create `todo/` directory structure
- [ ] Generate sample markdown task file
- [ ] Add sample TODO comments to source files
